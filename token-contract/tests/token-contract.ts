...
import { Program, setProvider, web3 } from "@coral-xyz/anchor";
import {
  MINT_SIZE,
  TOKEN_PROGRAM_ID,
...
describe("token-contract", () => {
  ...
  setProvider(anchor.AnchorProvider.env());
  ...
  // const mintKey: anchor.web3.Keypair = web3.Keypair.generate();
  ...
  it("Transfer token", async () => {
    ...
    const toWallet: web3.Keypair = web3.Keypair.generate();
